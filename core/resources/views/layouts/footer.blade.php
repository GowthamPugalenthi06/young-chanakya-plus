      ...
      <div class="container">
          <div class="row">
            <div class="col-lg-4 width-20">
              <div class="mb-10"><img src="{{ asset('assets/yc/imgs/yclogo-white.svg') }}" alt="yc"></div>
              <div class="col-lg-12 col-md-12 mb-3 mb-lg-0 text-center mt-3 d-flex justify-content-start align-items-center gap-2 row">
                <h6 class="color-white mb-1 ml-45 text-lg-start mr-2 col-lg-6 col-md-6 col-6">Follow Us</h6>
                <div class="rounded d-flex justify-content-center col-lg-12 col-md-6 col-6 ml-2 align-items-center p-2">
                  <a class="h mx-2 color-white" href="#">
                  <svg fill="blue" width="20" height="20" viewBox="0 0 24 22">
                  <path fill="white" d="M22.675 0h-21.35C.592 0 0 .593 0 1.326v21.348C0 23.407.592 24 1.325 
                    24H12.82v-9.294H9.692V11.01h3.128V8.413c0-3.1 1.894-4.788 4.659-4.788 
                    1.325 0 2.463.099 2.794.143v3.24l-1.918.001c-1.504 0-1.796.715-1.796 
                    1.763v2.31h3.587l-.467 3.696h-3.12V24h6.116c.73 0 1.324-.593 
                    1.324-1.326V1.326C24 .593 23.407 0 22.675 0z"/>
                  </svg>
                  </a>
                  <a class="h mx-2" href="#">
                    <svg fill="blue" width="20" height="20" viewBox="0 0 22 22">
                    <path fill="white" d="M14.5 10.6 23.5 0h-2.2L13.3 9.3 6.6 0H0l9.4 
                    12.9L0 24h2.2l8.4-9.5L17.4 24H24l-9.5-13.4z"/>
                    </svg>
                  </a>
                  <a class="h mx-2" href="#">
                    <svg fill="blue" width="24" height="26" viewBox="0 0 24 26">
                    <path fill="white" d="M7.75 2h8.5C20.097 2 22 3.903 22 7.75v8.5C22 20.097 20.097 22 16.25 22h-8.5C3.903 22 2 20.097 2 16.25v-8.5C2 3.903 3.903 2 7.75 2zm0 1.5C5.679 3.5 4.5 4.679 4.5 7.75v8.5c0 3.071 1.179 4.25 3.25 4.25h8.5c3.071 0 4.25-1.179 4.25-4.25v-8.5c0-3.071-1.179-4.25-4.25-4.25h-8.5zm4.25 4a5.75 5.75 0 1 1 0 11.5 5.75 5.75 0 0 1 0-11.5zm0 1.5a4.25 4.25 0 1 0 0 8.5 4.25 4.25 0 0 0 0-8.5zm5.5-1.25a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0z"/>

                    </svg>
                  </a>
                  <a class="h mb-1 mx-2" href="#">
                    <svg fill="blue" width="24" height="26" viewBox="0 0 24 26">
                    <path fill="white" d="M4.98 3.5C4.98 4.88 3.87 6 2.49 6S0 4.88 0 3.5 1.11 1 2.49 1 4.98 2.12 4.98 3.5zM.53 8.5h3.93V24H.53V8.5zM8.49 8.5h3.77v2.1h.05c.53-.95 1.83-1.95 3.77-1.95 4.03 0 4.77 2.65 4.77 6.1V24h-4.01v-7.6c0-1.8-.03-4.1-2.5-4.1-2.5 0-2.89 1.95-2.89 3.96V24H8.49V8.5z"/>
            ...
            <div class="col-lg- width-16 mb-30 ml-100">
            <h5 class="mb-10 color-white">Useful Links</h5>
            ...
            <h5 class="mb-10 color-white">Resources</h5>
              <ul class="menu-footer">
                <li><a href="{{route('podcast')}}"><p class="color-white">Podcast</p></a></li>
                <li><a href="{{route('blog')}}"><p class="color-white">Blog</p></a></li>
                <li><a href="{{route('case-studies')}}"><p class="color-white">Case Study</p></a></li>
                <li><a href="{{route('video-series')}}"><p class="color-white"><p class="color-white">Video Series</p></a></li>
                <li><a href="{{route('video-series')}}"><p class="color-white"><p class="color-white">Infographics</p></a></li>
              </ul>
            </DIV>
            <!-- <div class="col-lg-4 width-16 mb-30 ml-100 ">
              <h5 class="mb-10 color-white">Contact us</h5>
              <div class="d-flex align-items-start mb-2 color-white"><strong>
                <i class="bi bi-geo-alt me-2 mt-1"></i><strong>
                <p class="font-md mb-0 color-white">
                  West Car Street, Tiruchengode,<br class="d-none d-lg-block"> Tamil Nadu, India.
                </p>
              </div>
                <div class="font-md  color-white"><strong class="font-md-bold"><i class="bi bi-telephone me-2"></i></strong>+91-9647555066</div>
                <div class="font-md  color-white"><strong class="font-md-bold"></strong><i class="bi bi-envelope me-2"></i>info@younngchanakya.com</div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 width-16 mb-30">
              ...
              <ul class="menu-footer">
                ...
                <li><a href="{{ url('/careers') }}">Career &amp; Internships</a></li>
              </ul>
            </div>
