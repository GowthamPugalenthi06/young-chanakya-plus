    ...
    <section class="home-hero-section position-relative overflow-hidden">
      ...
      <div class="container position-relative content-layer">
        <div class="banner-1">
          <div class="row align-items-center">
            <div class="col-lg-7">
              <h1 class="text-white mb-20">India's Elite Startup Business Leadership Launchpad.</h1>
              <div class="row">
                <div class="col-lg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
      ...
      <div class="hero-bg-carousel swiper-container">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide bg-slide" style="background-image: url('assets/yc/imgs/page/homepage1/home-banner-1.png');"></div>
          <div class="swiper-slide bg-slide" style="background-image: url('assets/yc/imgs/page/homepage1/home-banner-2.png');"></div>
        </div>
      </div>
    </section>
        ...
        <div class="row mt-50 align-items-center">
          ...
          <div class="col-lg-6 wow animate__animated animate__fadeIn mb-4">
            <div class="card d-flex flex-row justify-content-between align-items-start p-3"
              ...
              <div class="card-image align-self-end" style="margin-bottom: -20px;">
