...
<div class="row">
    ...
    <div class="box-steps-small pt-100 pb-50">
      <div class="item-number hover-up active wow animate__animated animate__fadeInLeft" data-wow-delay=".0s">
        ...
        <div class="info-num">
          ...
          <p class="font-md color-grey-500">Provide your personal details including name, email, and contact number.</p>
        </div>
      </div>
  ...
  <div class="col-lg-6 pl-40">
    <div class="box-register">
      ...
      <p class="font-md color-grey-500 wow animate__animated animate__fadeIn">Fill in your details to join our volunteer community</p>
      ...
      <form id="volunteerForm">
        ...
        <div class="form-step step-2" style="display: none;">
          <div class="row">
            <div class="col-lg-6 col-sm-6">
              <div class="form-group mb-25">
                <input class="form-control" type="date" placeholder="DOB" onfocus="this.showPicker && this.showPicker()">
              </div>
            </div>
            <div class="col-lg-6 col-sm-6">
              <div class="form-group mb-25">
                <textarea class="form-control" placeholder="Current Address"></textarea>
              </div>
            </div>
            <div class="col-lg-6 col-sm-6">
              <div class="form-group mb-25">
                <input class="form-control" type="url" placeholder="LinkedIn Profile">
              </div>
            </div>
            <div class="col-lg-6 col-sm-6">
              <div class="form-group mb-25">
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="form-group mb-25">
                <input class="form-control" type="text" placeholder="Institution/Organization">
              </div>
            </div>
            <div class="col-lg-6 col-sm-6">
              <div class="form-group mb-25">
                <input class="form-control" type="text" placeholder="Designation (if working)">
              </div>
            </div>
