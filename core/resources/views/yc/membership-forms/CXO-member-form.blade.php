    ...
    <div class="box-steps-small pt-100 pb-50">
      <div class="item-number hover-up active wow animate__animated animate__fadeInLeft" data-wow-delay=".0s">
        ...
        <div class="info-num">
          ...
          <p class="font-md color-grey-500">Provide your personal and professional details to get started.</p>
        </div>
      </div>
      <div class="item-number hover-up wow animate__animated animate__fadeInLeft" data-wow-delay=".1s">
        ...
        <div class="info-num">
          ...
          <p class="font-md color-grey-500">Your details will be reviewed for eligibility and authenticity.</p>
        </div>
      </div>
