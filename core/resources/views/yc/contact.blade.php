          ...
          <div class="banner-1">
            <div class="row align-items-center">
              <div class="col-lg-7"><span class="title-line line-48 wow animate__animated animate__fadeIn" data-wow-delay=".0s">Get in Touch</span>
                ...
                <div class="row">
                  <div class="col-lg-9">
                    <p class="font-md color-grey-500 wow animate__animated animate__fadeIn" data-wow-delay=".4s">Request a demo, ask a question, or get in touch here. If you’re interested in working at Young chanakya Coporation, check out our<a class="ml-3" href="#"> Job page.</a></p>
                  </div>
                </div>
           
              </div>
              <div class="col-lg-5 d-none d-lg-block">
                <div class="box-banner-contact"><img src="assets/yc/imgs/page/contact/banner.png" alt="Young chanakya"></div>
              </div>
            </div>
          </div>
        </div>
      </section>
      <section class="section mt-100 d-flex justify-content-center">
        <div class="container d-flex justify-content-center">
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-small card-small-2">
                <div class="card-image">
                  <div class="box-image"><img src="assets/yc/imgs/page/contact/headphone.png" alt="Young chanakya"></div>
                </div>
                <div class="card-info">
                  <h6 class="color-brand-1 mb-10">Help &amp; support</h6>
                  <p class="font-xs color-grey-500">Email<a class="color-success" href="mailto:info@youngchanakya.com">info@youngchanakya.com</a><br>For help with a current product<BR> or service or refer to FAQs and developer tools</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
              <div class="card-small card-small-2">
                <div class="card-image">
                  <div class="box-image"><img src="assets/yc/imgs/page/contact/phone.png" alt="Young chanakya"></div>
                </div>
                <div class="card-info">
                  <h6 class="color-brand-1 mb-10">Call Us</h6>
                  <p class="font-xs color-grey-500">Call us to speak to a member of our team.<br>
+91-9647555066
</p>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
              <div class="card-small card-small-2">
                <div class="card-image">
                  <div class="box-image"><img src="assets/yc/imgs/page/contact/earth.png" alt="Young chanakya"></div>
                </div>
                <div class="card-info">
                  <h6 class="color-brand-1 mb-10">Address</h6>
              ...
              <div class="mt-50">
                <div class="wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
                  <div class="card-offer card-we-do card-contact hover-up">
                    <div class="card-image"><img src="assets/yc/imgs/page/contact/img1.png" alt="Young chanakya"></div>
                    <div class="card-info">
                ...
                <div class="wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                  <div class="card-offer card-we-do card-contact hover-up">
                    <div class="card-image"><img src="assets/yc/imgs/page/contact/img2.png" alt="Young chanakya"></div>
                    <div class="card-info">
                ...
                <div class="wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                  <div class="card-offer card-we-do card-contact hover-up">
                    <div class="card-image"><img src="assets/yc/imgs/page/contact/img3.png" alt="Young chanakya"></div>
                    <div class="card-info">
