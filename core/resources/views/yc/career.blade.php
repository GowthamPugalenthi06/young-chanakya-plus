  ...
  <body>
    ...
    <main class="main">
      ...
      <section class="section pt-50 pb-100">
        <div class="container">
          <div class="box-image-detail"><img class="bd-rd16 d-block" src="{{asset('assets/yc/imgs/page/job-detail/img-job.png')}}" alt="iori"></div>
        ...
        <div class="container">
          ...
          <div class="row mt-50">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
              <div class="card-offer hover-up">
                <div class="card-image"><img src="{{asset('assets/yc/imgs/page/job-detail/senior.png')}}" alt="iori"></div>
                <div class="card-info">
