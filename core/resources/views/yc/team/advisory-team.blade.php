    ...
    <section class="section mt-50 pt-50">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-5 mb-30"><span class="title-line line-48 wow animate__animated animate__fadeInUp">Shaping
              the Vision</span>
            <h2 class="color-brand-1 mt-10 mb-15 wow animate__animated animate__fadeInUp">Advisory Team</h2>
            <p class="font-md color-grey-400 wow animate__animated animate__fadeInUp">The Advisory Team consists of
              highly accomplished business minds, global leaders, academic scholars, and institutional founders who
              shape the strategic direction of Young Chanakya.
              They ensure the program remains relevant, visionary, and aligned with the global startup and innovation
              ecosystem.</p>
          ...
          <div class="col-lg-4 mb-30 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
            <div class="card-guide bg-4">
              ...
              <div class="card-info">
                ...
                <p class="font-md color-grey-500">Steering the institution with long-term goals and startup industry
                  alignment</p>
          ...
          <div class="col-lg-4 mb-30 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
            <div class="card-guide bg-5">
              ...
              <div class="card-info">
                ...
                <p class="font-md color-grey-500">Ensuring innovation and quality in all academic and leadership
                  offerings</p>
          ...
          <div class="col-lg-4 mb-30 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
            <div class="card-guide bg-7">
              ...
              <div class="card-info">
                ...
                <p class="font-md color-grey-500"> Bridging connections with global institutions, incubators, and
                  ecosystems</p>
    ...
    <section class="section mt-90">
      <div class="container">
        ...
        <h2 class="color-brand-1 mb-50 wow animate__animated animate__fadeIn" data-wow-delay=".2s">Together we are
          strong</h2>
        <div class="row">
          @foreach($advisory_team as $member)
