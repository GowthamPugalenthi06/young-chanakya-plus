    ...
    <section class="section mt-50 pt-50">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-5 mb-30"><span class="title-line line-48 wow animate__animated animate__fadeInUp">Guiding
              the Journey</span>
            <h2 class="color-brand-1 mt-10 mb-15 wow animate__animated animate__fadeInUp">Mentor Team</h2>
            <p class="font-md color-grey-400 wow animate__animated animate__fadeInUp">Our Mentor Team is a powerhouse of
              successful entrepreneurs, startup founders, industry experts, and innovation leaders who bring real-world
              experience to the table.
              They guide students through every phase of their leadership journey — from idea validation to go-to-market
              strategies — through 1:1 sessions, live mentoring circles, and tactical masterclasses.</p>
          ...
          <div class="col-lg-7 text-center position-relative mb-30"><img
              src="{{ asset('assets/yc/imgs/page/team/mentor-team.png') }}" alt="iori">
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-lg-4 mb-30 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
            <div class="card-guide bg-4">
              ...
              <div class="card-info">
                ...
                <p class="font-md color-grey-500">Personalized guidance from seasoned entrepreneurs and startup founders
                </p>
          ...
          <div class="col-lg-4 mb-30 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
            <div class="card-guide bg-5">
              ...
              <div class="card-info">
                ...
                <p class="font-md color-grey-500"> Actionable insights shared through real-time sessions and workshops
                </p>
    ...
    <section class="section mt-90">
      <div class="container">
        ...
        <h2 class="color-brand-1 mb-50 wow animate__animated animate__fadeIn" data-wow-delay=".2s">Together we are
          strong</h2>
        <div class="row">
          @foreach($mentor_teams as $member)
