...
@section('content')
  <div class="page-header">
    <h4 class="page-title">Add Mentor - Mentor Chanakya</h4>
  ...
  <div class="row">
    ...
    <div class="card">
      ...
      <form action="{{ route('admin.mentor_chanakya.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <style>
                    label {
        ...
        <select name="category" class="form-control" required>
          <option value="CEO and MD">CEO and MD</option>
          <option value="Unicorn Founders">Unicorn Founders</option>
          <option value="Executive">Executive</option>
          <option value="Fortune 500's">Fortune 500's</option>
        </select>
        </div>
