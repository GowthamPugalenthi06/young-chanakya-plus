...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus', 'setLfmPath']], function () {
  ...
  Route::group(['middleware' => 'checkpermission:Content Management'], function () {
    ...
    Route::group(['middleware' => 'checkpermission:Shop Management'], function () {
        ...
        Route::get('/product/settings', 'Admin\ProductController@settings')->name('admin.product.setting');
    ...
    Route::group(['middleware' => 'checkpermission:Donation Management'], function () {
        ...
        Route::get('/donation/settings', 'Admin\DonationController@settings')->name('admin.donation.setting');
    ...
    Route::group(['middleware' => 'checkpermission:Course Management'], function () {
        ...
        Route::get('/course/settings', 'Admin\CourseController@settings')->name('admin.course.setting');
    ...
    Route::group(['middleware' => 'checkpermission:Tickets'], function () {
        ...
        Route::get('/ticket/settings', 'Admin\TicketController@settings')->name('admin.ticket.setting');
...
Route::group(['middleware' => ['setlang']], function () {
  try {
      ...
      foreach ($wdPermalinks as $pl) {
          ...
          switch ($type) {
              case 'package_order':
                  Route::get("$permalink/{id}", 'Front\FrontendController@packageorder')
                      ->name('front.packageorder.index');
                  break;

              case 'service_details':
                  Route::get("$permalink/{slug}", 'Front\FrontendController@servicedetails')
                      ->name('front.servicedetails');
                  break;

              case 'portfolio_details':
                  Route::get("$permalink/{slug}", 'Front\FrontendController@portfoliodetails')
                      ->name('front.portfoliodetails');
                  break;

              case 'product_details':
                  Route::get("$permalink/{slug}", 'Front\ProductController@productDetails')
                      ->name('front.product.details');
                  break;

              case 'course_details':
                  Route::get("$permalink/{slug}", 'Front\CourseController@courseDetails')
                      ->name('course_details');
                  break;

              case 'cause_details':
                  Route::get("$permalink/{slug}", 'Front\FrontendController@causeDetails')
                      ->name('front.cause_details');
                  break;

              case 'event_details':
                  Route::get("$permalink/{slug}", 'Front\FrontendController@eventDetails')
                      ->name('front.event_details');
                  break;

              case 'career_details':
                  Route::get("$permalink/{slug}", 'Front\FrontendController@careerdetails')
                      ->name('front.careerdetails');
                  break;

              case 'knowledgebase_details':
                  Route::get("$permalink/{slug}", 'Front\FrontendController@knowledgebase_details')
                      ->name('front.knowledgebase_details');
                  break;

              case 'blog_details':
                  Route::get("$permalink/{slug}", 'Front\FrontendController@blogdetails')
                      ->name('front.blogdetails');
                  break;

              case 'rss_details':
                  Route::get("$permalink/{slug}/{id}", 'Front\FrontendController@rssdetails')
